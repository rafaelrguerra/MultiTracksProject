        ...
        <div class="wrapper mod-standard mod-gray">
            <div class="details-banner">
                ...
                <div class="details-banner--info">
                    <a href="#" class="details-banner--info--box">
                        <asp:Image ID="artistImage" runat="server" class="details-banner--info--box--img" />
                    </a>
                    <h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#">
                        <asp:Literal ID="artist" runat="server"></asp:Literal></a></h1>
                </div>
            </div>
            ...
            <div class="discovery--container u-container">
                <main class="discovery--section">
                    ...
                    <section class="standard--holder" id="songsSection" runat="server">
                        <div class="discovery--section--header">
                            <h2 id="topSongs" runat="server">Top Songs</h2>
                            <asp:LinkButton class="discovery--section--header--view-all" ID="viewAllSongsButton" runat="server" OnClick="viewAllSongs_Click">View All</asp:LinkButton>
                        </div>
                        <!-- /.discovery-select -->

                        <ul runat="server" id="songs" class="song-list mod-new mod-menu">
                            <asp:Repeater runat="server" ID="songList">
                                <ItemTemplate>
                                    <li class="song-list--item media-player--row">
                                        ...
                                        <div class="song-list--item--right">
                                            ...
                                            <a href="#" class="song-list--item--primary"><%#Eval("Song") %></a>
                    ...
                    <div class="discovery--space-saver" id="albumsSection" runat="server">
                        <section class="standard--holder">
                            ...
                            <div class="discovery--grid-holder">
                                ...
                                <div class="ly-grid ly-grid-cranberries" runat="server" id="albums">
                                    <asp:Repeater runat="server" ID="albumList">
                                        <ItemTemplate>
                                            <div class="media-item">
                                                <a class="media-item--img--link" href="#" tabindex="0">
                                                    <img class="media-item--img" alt="Reckless Love" src="<%#Eval("AlbumImage") %>" srcset="<%#Eval("AlbumImage") %> 2x">
                                                    <span class="image-tag">Master</span>
                                                </a>
                                                <a class="media-item--title" href="#" tabindex="0"><%#Eval("Album") %></a>
                                                <a class="media-item--subtitle" href="#" tabindex="0"><%#Eval("Artist") %></a>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                    ...
                    <section class="standard--holder" id="biographySection" runat="server">
                        <div class="discovery--section--header">
                            <h2>Biography</h2>
                        </div>
                        ...
                        <div class="artist-details--biography biography">
                            ...
                            <p></p>
                            <asp:LinkButton class="discovery--section--header--view-all" ID="readMoreButton" runat="server" OnClick="readMore_Click">Read More...</asp:LinkButton>
                        </div>
                    </section>
                    <!-- /.biography-section -->
                </main>
